...
import { allGiftCards,  createGift,deleteHistory,  oneGiftCard, populateGiftCard, populateHistory, viewAllHistory } from "../controller/GiftController"

const gift = express.Router()

gift.route("/create-gift").post(createGift)
